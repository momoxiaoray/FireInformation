...
import com.xx.fire.activity.dynamic.MyDynamicActivity;
...
public class UserFragment extends Fragment {
    ...
    @OnClick({R.id.collection, R.id.about, R.id.btn_login_out,R.id.dynamic})
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.collection:
                ...
                break;
            case R.id.dynamic:
                ActivityUtils.startActivity(MyDynamicActivity.class);
                break;
            case R.id.about:
