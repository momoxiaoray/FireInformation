...
public class ItemCollectAdapter extends RecyclerView.Adapter<ItemCollectAdapter.ViewHolder> {

    private final List<News> mValues;
    private OnItemActionListener onItemActionListener;
    private Context context;

    public ItemCollectAdapter(Context context, List<News> items) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.scanCount.setText(news.getNews_type() == 0 ? context.getString(R.string.tab_text_1) : context.getString(R.string.tab_text_2));
